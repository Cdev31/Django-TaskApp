...
confirmationEliminatedButton.forEach((btn)=>{console.log(btn.nextElementSibling)
btn.addEventListener('click',eliminatedCategory)});const menu=document.getElementById('menu')
