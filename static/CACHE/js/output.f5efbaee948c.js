...
let numberInputs=0
while(inputs.length>=numberInputs){console.log(inputs[numberInputs],' ',inputs[numberInputs].value?.length)
if(inputs[numberInputs].value?.length>0){numberInputs=numberInputs+1}
break}
